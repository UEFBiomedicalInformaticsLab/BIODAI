...
class WorkerState:
    ...
    def __evaluate_objective(
            ...
            objective: PersonalObjective) -> (float, MVPredictor, Optional[list[float]]):
        ...
        return o_val, final_predictor, None  # TODO Fill feature importance if needed.
    ...
    def evaluate(self, work_package: WorkPackage, check_picklability=False, verbose=False) -> WorkerResult:
        ...
        try:
            ...
            predictors = []
            for o in objectives:
                o_val, predictor, o_fi = self.__evaluate_objective(individual=individual, objective=o)
                fit.append(o_val)
