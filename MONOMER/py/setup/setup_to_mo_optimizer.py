...
from setup.allowed_names import SOCIAL_SPACE_NAME, CROWDING_DISTANCE_NAME, SOCIAL_SPACE_FULL_NAME, \
    ...
    SWEEPING_NAME, LASSO_MO_NAME, GUIDED_FORWARD_NAME, RFE_NAME, NSGA3_NAME
...
from setup.ga_mo_optimizer_setup import big_nsga_setup, big_sweeping_ga_mo_optimizer_setup, \
    small_nsga_setup, small_sweeping_ga_mo_optimizer_setup, DEFAULT_HOFS
...
def setup_to_mo_optimizer(setup: EvaluationSetup, printer: Printer
    ...
    elif mvmo_algorithm == NSGA_STAR_NAME or mvmo_algorithm == SWEEPING_NAME or mvmo_algorithm == GUIDED_FORWARD_NAME or mvmo_algorithm == RFE_NAME:
    ...
    run_sweeping_ga = (mvmo_algorithm == SWEEPING_NAME)
    ...
    if mvmo_algorithm == LASSO_NAME:
        ...
        mo_optimizer = GuidedForwardAcceptingFI(
            folds_creator=InputDataKFoldsCreator(n_folds=inner_n_folds),
        ...
        if use_big_setup:
            if run_nsga:
                ...
                mo_optimizer = big_sweeping_ga_mo_optimizer_setup(
                    objectives=objectives, sweeping_strategy=SweepingStrategy(generations),
                    mating_prob=mating_prob, mutating_prob=mutation_frequency,
                    pop_size=pop,
                    initial_features=initial_features,
                    sorting_strategy=sorting_strategy,
            ...
            if run_nsga:
                ...
                mo_optimizer = small_sweeping_ga_mo_optimizer_setup(
                    objectives=objectives,
                    sweeping_strategy=SweepingStrategy(generations),
                    pop_size=pop,
                    initial_features=initial_features,
                    mating_prob=mating_prob, mutating_prob=mutation_frequency,
                    sorting_strategy=sorting_strategy,
