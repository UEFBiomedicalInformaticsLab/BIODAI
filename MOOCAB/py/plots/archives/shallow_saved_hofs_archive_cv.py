...
from plots.archives.automated_hofs_archive import all_ga_hofs_with_inner_model_cv, \
...
LOCATION_MANAGER = BasicLocationManager()

TCGA_BRCA_1000_FO_NB = LOCATION_MANAGER.default_saved_hof_from_labels_cv(dataset_lab=TCGA_BRCA_LAB, main_lab=NSGA2_CHS_LAB, inner_lab=NB_LAB)
TCGA_BRCA_1000_FO_RF = LOCATION_MANAGER.default_saved_hof_from_labels_cv(dataset_lab=TCGA_BRCA_LAB, main_lab=NSGA2_CHS_LAB, inner_lab=RF_LAB)
TCGA_BRCA_1000_FO_LOGIT = LOCATION_MANAGER.default_saved_hof_from_labels_cv(dataset_lab=TCGA_BRCA_LAB, main_lab=NSGA2_CHS_LAB, inner_lab=LR_LAB)
...
TCGA_BRCA_LASSO = LOCATION_MANAGER.default_saved_hof_from_labels_cv(dataset_lab=TCGA_BRCA_LAB, main_lab=LASSO_MO_LAB)
