...
from comparators import Comparator, ComparatorOnSocialSpace
...
class Nsga2WithSocialSpace(NSGA2WithSecondarySortingStrategy):

    def __init__(self):
        NSGA2WithSecondarySortingStrategy.__init__(
            self=self,
