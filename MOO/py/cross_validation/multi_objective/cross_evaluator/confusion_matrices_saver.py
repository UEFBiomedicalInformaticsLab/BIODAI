...
from cross_validation.multi_objective.cross_evaluator.hof_saver import path_for_saves
    ...
    for i, obj in enumerate(objectives):
        if obj.has_outcome_label():
            ...
            if outcome.type() == OutcomeType.categorical:
                ...
                cms = confusion_matrices_from_predictors_and_test(predictors=predictors, views=views, outcome=outcome)
