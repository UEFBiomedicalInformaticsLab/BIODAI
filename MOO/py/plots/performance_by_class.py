...
from plots.plot_utils import hof_folds_feature_counts, feature_counts_from_df
...
def one_performance_by_class_plot(
    ...
    if n_solutions > 0:
        ...
        save_multiclass_scatter(x=x, y=y, save_file=os.path.join(hof_dir, name_for_path + "_by_class.png"),
                                class_labels=labels, x_label="number of features", y_label=performance_name,
                                y_max=1.02)
