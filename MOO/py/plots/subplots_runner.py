...
from plots.plot_labels import ALL_CV_DATASETS
...
SETUP = PlotSetup(x_min=X_MIN, x_max=X_MAX, y_min=Y_MIN, y_max=Y_MAX, alpha=ALPHA, labels_map=default_labels_map)
...
if __name__ == '__main__':
    for ext in ALL_EXTERNAL_VALIDATIONS:
    ...
    for dataset_label in ALL_CV_DATASETS:
        ...
        hofs = nested_hofs_for_dataset_cv(dataset_lab=dataset_label)
        subscatterplots(
            hofs=hofs,
