...
from run_one_setup import run_one_setup
...
def run_with_setups():
    ...
    with ExclusiveNumber() as exclusive_number:
        ...
        printer.title_print("Executing cross-validations")
        ...
        for i in range(len(setups)):
            run_one_setup(setup=setups[i], printer=printer, config_file=sys.argv[i+1])
