...
from util.math.list_math import indices_of_true
...
class SelectHpManager(HyperparamManager):
    ...
    __view_pops: Sequence[Sequence[PeculiarIndividual]]
    __n_view_individuals: list[int]

    def __init__(self, view_pops: Sequence[Sequence[PeculiarIndividual]]):
