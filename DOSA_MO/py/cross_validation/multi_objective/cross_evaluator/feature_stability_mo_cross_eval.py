...
from validation_registry.allowed_property_names import STABILITY_BY_WEIGHTS_NAME, STABILITY_BY_DICE_NAME, \
...
class FeatureStabilityMOCrossEval(MultiObjectiveCrossEvaluator):
    ...
    def evaluate(self, input_data: InputData, folds,
        ...
        hof_registry.set_property(name=STABILITY_BY_DICE_NAME, value=stab_by_unions)
