...
from validation_registry.allowed_property_names import STABILITY_BY_DICE_NAME, STABILITY_BY_DICE_NICK


class RunDice(RunMeasure):
    ...
    def name(self) -> str:
        return STABILITY_BY_DICE_NAME

    def nick(self) -> str:
        return STABILITY_BY_DICE_NICK
