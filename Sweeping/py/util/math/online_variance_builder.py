...
class OnlineVarianceBuilder(VarianceBuilder):
    ...
    __n: int
    __mean: KahanSummer  # The sum in this summer is the mean of the distribution.
    __tot_sum_squares: KahanSummer  # Total sum of squares.
    ...
    def add(self, x: float):
        ...
        self.__mean.add_unchecked(delta/float(self.__n))
        delta2 = x - self.__mean.get_sum()
        self.__tot_sum_squares.add_unchecked(delta*delta2)
