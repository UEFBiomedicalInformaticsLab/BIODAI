...
from model.class_crisp.masked_classifier import MaskedClassModel
from model.class_crisp.classifier_with_coef import ClassModelWithCoef
from model.class_crisp.logistic import LassoWithFallback
