...
from util.dataframe.dataframes import has_column
...
class ClassAndSurvBestEffortInputCreator(InputCreator):
    ...
    def __init__(self, nick: str, class_outcome_col: str, class_outcome_name: str = "type",
                 surv_event_col: str = "Event", surv_time_col: str = "Time", name: Optional[str] = None):
        InputCreator.__init__(self, nick=nick, name=name)
    ...
    def inner_create(self, views_to_load: AdjustedViewDef, printer: Printer) -> InputData:
        ...
        return InputData.smart_create(
            ...
            stratify_outcome=self.__class_outcome_name, adjusted_views=views_to_load, name=self.name())
