...
class BrcaInputCreator(InputCreator):
    ...
    def inner_create(self, views_to_load: AdjustedViewDef, printer: Printer) -> InputData:
        ...
        wanted_views = views_to_load.all_views_seq()
        views = load_omics_views.load_all_views(input_dir, views=wanted_views, printer=printer,
        ...
        return InputData.smart_create(
            all_views=views, outcomes=outcomes, nick=self.nick(), stratify_outcome=OUTCOME_PAM50_NAME,
