...
from individual.individual_with_context import IndividualWithContextSV
...
class ExploredFeatures:
    ...
    def update(self, pop):
        for i in pop:
            ...
            if isinstance(i, IndividualWithContextSV):
                mask = i.collapsed_used_features_mask()  # We extract the mask for performance reasons.
            else:
                mask = i
