...
class IndividualByListlike(Individual, ABC):
    """Has coherent equals and hash that depend only on the list."""
    ...
    def _init_list_like(seq) -> ListLike:
        """Initialise the list like object. Passed seq is safe-copied."""
    ...
    def extend(self, iterable: Iterable):
        self.__list_like.extend(iterable)
