...
from validation_registry.allowed_property_names import STABILITY_BY_BEST_DICE_NICK, STABILITY_BY_BEST_DICE_NAME
...
class RunBestDice(RunMeasure):
    ...
    def name(self) -> str:
        return STABILITY_BY_BEST_DICE_NAME

    def nick(self) -> str:
        return STABILITY_BY_BEST_DICE_NICK
