...
class MultiObjectiveOptimizerAcceptingFeatureImportance(MultiObjectiveOptimizer, ABC):
    ...
    def optimize(self, input_data: InputData, printer: Printer, n_proc: int = 1,
        ...
        return self.optimize_with_feature_importance(
            ...
            feature_importance={v: UniformDistribution(views[v].n_col()) for v in input_data.predictive_view_names()},
