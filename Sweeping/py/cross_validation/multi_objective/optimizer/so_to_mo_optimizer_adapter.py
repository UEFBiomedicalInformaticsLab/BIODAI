...
class SOtoMOOptimizerAdapter(MultiObjectiveOptimizer):
    ...
    def optimize(self, input_data: InputData, printer, n_proc=1,
        ...
        so_res = self.__so_optimizer.optimize(
            input_data=input_data.model_ready(outcome=input_data.stratify_outcome_name()))
        return [MultiObjectiveOptimizerResult(
            ...
            hyperparams=[IndividualWithContextMV(individual=so_res.hyperparams, hp_manager=so_res.hp_manager)])]
