...
def one_performance_by_class_plot_to_ax(
        ...
        performance_name: str, legend_loc: str = 'best',
    ...
    if n_solutions > 0:
        ...
        multiclass_scatter_to_ax(ax=ax, x=x, y=y, x_label="number of features", y_label=performance_name,
                                 class_labels=labels, legend_loc=legend_loc,
                                 x_min=x_min, x_max=x_max,
                                 y_min=y_min, y_max=y_max,
                                 vertical_lines=vertical_lines, interpolate=interpolate, add_ellipses=add_ellipses,
                                 decimals=decimals)
