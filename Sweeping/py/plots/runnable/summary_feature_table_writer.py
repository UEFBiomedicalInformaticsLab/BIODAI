...
from util.dataframe.dataframes import to_csv_makingdirs
...
def summary_feature_table_writer_one_hof(
    ...
    for dataset_label in test_battery.dataset_labels():
        ...
        if n_views(names=colnames) < 2:
            res_df = res_df.set_axis(all_unprefixed(names=colnames), axis=1)
        ...
        if n_views(names=all_features) < 2:
            ...
            res_df = res_df.set_axis(colnames, axis=1)
