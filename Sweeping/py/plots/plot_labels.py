...
from input_data.input_creator.input_creators_archive import KID_GSE152938D_T2_NICK, ORIGINAL_KIRC_MV_NICK, KID_GSE152938D_NICK, \
    CPTAC3_SUB_UQ4_NICK, EXT_OV2_NICK, LGG_MV_NICK, TCGA_PRAD_NICK
...
NON_GA_MAIN_WITH_INNER = [RFE_LAB, GF_LAB, CMDPSOFS_LAB]
...
ALL_MAIN_NO_NSGA3 = [LASSO_MO_LAB] + NON_GA_MAIN_WITH_INNER + [NSGA2_LAB, NSGA2_CH_LAB, NSGA2_CHS_LAB]
NATURE_INSPIRED_NO_NSGA3_MAIN = [CMDPSOFS_LAB + NSGA2_LAB, NSGA2_CH_LAB, NSGA2_CHS_LAB]
NATURE_INSPIRED_MAIN = ALL_GA_LABS + [CMDPSOFS_LAB]
...
ALL_INNER_LABS = [NB_LAB, SVM_LAB, TREE_LAB, RF_LAB, RF_LEGACY_LAB, LR_LAB]
LEGACY_INNER_LABS = [NB_LAB, SVM_LAB, TREE_LAB, RF_LEGACY_LAB, LR_LAB]
...
KID_GSE152938D_LAB = KID_GSE152938D_NICK
KID_GSE152938D_T2_LAB = KID_GSE152938D_T2_NICK
CPTAC3_SUB_UQ4_LAB = CPTAC3_SUB_UQ4_NICK
TCGA_BRCA_MRNA_MIRNA_LAB = "tcga_brca_mrna_mirna"
COAD_MV_LAB = "coad_mv"
KIRC_MV_LAB = "kirc_mv"
SARC_MV_LAB = "sarc_mv"
LGG_MV_LAB = LGG_MV_NICK
ORIGINAL_KIRC_MV_LAB = ORIGINAL_KIRC_MV_NICK
EXT_OV2_LAB = EXT_OV2_NICK

ALL_CV_DATASETS = [
    TCGA_BRCA_LAB, TCGA_LU_LAB, TCGA_LU2_LAB, TCGA_DIG5_LAB, TCGA_KI_LAB, TCGA_OV_LAB,
    TCGA_THCA3_LAB, TCGA_THCA_BL_LAB, TCGA_DIG_TYPE_LAB, COAD_MV_LAB, KIRC_MV_LAB,
    TCGA_PRAD_LAB]
...
def has_population(main_lab: str) -> bool:
    return main_lab in NATURE_INSPIRED_MAIN


def has_generations(main_lab: str) -> bool:
    return main_lab in NATURE_INSPIRED_MAIN