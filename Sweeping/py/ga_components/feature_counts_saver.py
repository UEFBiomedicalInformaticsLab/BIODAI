...
def feature_counts_to_df(feature_counts: Sequence[Sequence[int]], feature_names: Sequence[str], save_interval: int = 1):
...
def feature_counts_to_csv(
        feature_counts: Sequence[Sequence[int]], feature_names: Sequence[str], file: str, save_interval: int = 1):
...
class FeatureCountsSaver(ABC):
    ...
    @abstractmethod
    def save(self, feature_counts: Sequence[Sequence[int]], feature_names: Sequence[str]):
