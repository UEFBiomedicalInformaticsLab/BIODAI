...
def fill_missing_properties_one_hof(
    ...
    """Include_folds: Set to True to force the computations of the single folds for the properties that also define a
    fold by fold computation."""
        ...
        if os.path.isdir(hof_dir):
            ...
            if include_folds and prop.has_folds_property_name():
                if not prop.has_complete_folds_property(registry=registry):
                    ...
                    print("Property " + folds_prop_name + " not found or not complete.")
