...
SOFT_CROSS_HV_NICK = "soft_cross_hypervol"
...
STABILITY_BY_DICE_NICK = "Dice"  # Same as stability by unions when the cardinalities are the same.
STABILITY_BY_SET_OVERLAP_NICK = "set_overlap"  # A.k.a. stability by unions.
...
SOFT_CROSS_HV_NAME = "soft cross hypervolume"
...
FOLDS_CROSS_HV_NAME = FOLDS_PREFIX + CROSS_HV_NAME
FOLDS_SOFT_CROSS_HV_NAME = FOLDS_PREFIX + SOFT_CROSS_HV_NAME
...
FOLDS_MEAN_JACCARD_NAME = FOLDS_PREFIX + MEAN_JACCARD_NAME
STABILITY_BY_WEIGHTS_NAME = "stability by weight overlap"
STABILITY_BY_SET_OVERLAP_NAME = "stability by set overlap"  # A.k.a. stability by unions.
STABILITY_BY_DICE_NAME = "stability by Dice"  # Same as stability by unions when the cardinalities are the same.
...
ALLOWED_PROPERTY_NAMES = {
    INNER_CV_HV_NAME, TRAIN_HV_NAME, TEST_HV_NAME, CROSS_HV_NAME, SOFT_CROSS_HV_NAME,
    FOLDS_INNER_CV_HV_NAME, FOLDS_TRAIN_HV_NAME, FOLDS_TEST_HV_NAME, FOLDS_CROSS_HV_NAME, FOLDS_SOFT_CROSS_HV_NAME,
    MEAN_JACCARD_NAME, FOLDS_MEAN_JACCARD_NAME,
    STABILITY_BY_WEIGHTS_NAME, STABILITY_BY_SET_OVERLAP_NAME, STABILITY_BY_BEST_DICE_NAME,
...
RENAMES = [("stability by weights", STABILITY_BY_WEIGHTS_NAME),
           ("stability by unions", STABILITY_BY_SET_OVERLAP_NAME)]
