...
from validation_registry.allowed_property_names import TEST_HV_NAME, CROSS_HV_NAME, FOLDS_TEST_HV_NAME, \
    ...
    STABILITY_BY_SET_OVERLAP_NAME, STABILITY_BY_SET_OVERLAP_NICK, SOFT_CROSS_HV_NAME, SOFT_CROSS_HV_NICK, \
    FOLDS_SOFT_CROSS_HV_NAME
...
SOFT_CROSS_HV_PROPERTY = RegistryPropertyWithMean(
    property_name=SOFT_CROSS_HV_NAME, nick_for_humans=SOFT_CROSS_HV_NICK, folds_property_name=FOLDS_SOFT_CROSS_HV_NAME,
    folds_computer=HofPropertyComputerFromFoldMeasure(measure=RunSoftCrossHypervolume()))
